...
import { reflectionOption, scrollBody, stepFooter, stepShell, stepSubtitle, stepTitle } from '../../../lib/flowClasses'
  ...
  return (
    <div className={cn(stepShell, 'overflow-y-auto')}>
      <div className={scrollBody}>
        ...
        <textarea
          className="input-area input-area--compact mb-6"
          placeholder=""
          value={note}
      ...
      <div className={stepFooter}>
        <button type="button" className="btn-main" onClick={onFinish}>점 찍기 💧</button>
      </div>
    </div>
  )
}
